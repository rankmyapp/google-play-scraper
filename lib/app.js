...
const {MAPPINGS, FALLBACK_MAPPINGS} = require('./mappers/details');

const BASE_URL = 'https://play.google.com/store/apps/details';
const PLAYSTORE_URL = 'https://uurpiwzhr6.execute-api.us-east-1.amazonaws.com/v1/store/apps/details';
...
function app(opts) {
  return new Promise(function(resolve, reject) {
    ...
    request(options, opts.throttle)
      ...
      .then(scriptData.extractor(MAPPINGS, FALLBACK_MAPPINGS))
