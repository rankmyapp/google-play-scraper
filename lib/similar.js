...
const PLAYSTORE_URL = 'https://google-play-scraper.azure-api.net/store/apps/details';
    ...
    request(options, opts.throttle)
      ...
      .then(data => {
        ...
        return request(Object.assign({
          url: `https://google-play-scraper.azure-api.net${data.path}&gl=${opts.country}&hl=${opts.lang}`,
          followAllRedirects: true
        }, opts.requestOptions));
      })
      .then(scriptData.parse)
